...
<div>
  <h4 style = "float:left; width:30%; margin-left: 10px;">Reduce colours</h4>
  <h4 style = "float:left; width:30%; margin-left: 10px;">Rotate palette</h4>
  <h4 style = "float:left; width:30%; margin-left: 10px;">Cross-fade between palettes</h4>
</div>
