...
#'
write_ppm <- function(arr, filename, convert_to_row_major = TRUE, intensity_factor = 1) {
    invisible(.Call(`_foist_write_ppm_core`, arr, dim(arr), filename, convert_to_row_major, intensity_factor))
}
